...
module "myapp" {
  ...
  workers = {
    ...
    # A worker whose tasks drive hardware takes what it needs alone, rather than the stack taking it
    # on every container. Bluetooth over BlueZ wants the system bus and NET_ADMIN.
    domotic = {
      name          = "domotic"
      queues        = ["domotic"]
      log_level     = "info"
